...
## Instalação
```bash
composer require agenciafmd/laravel-hubspot:v11.x-dev
```
...
Neste caso dos prints, o projeto precisava apenas de nome, email e telefone, então já comecei removendo o campo de
